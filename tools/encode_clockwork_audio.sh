...
encode_directory "assets/stems/clockwork"
encode_directory "assets/stingers/clockwork"
encode_directory "assets/transitions/clockwork"

echo "Encoded Clockwork M4A/OGG variants"
